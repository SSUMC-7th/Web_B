...
const MovieDetail = () => {
    ...
    const {data:movie, isLoading, isError} = useDetailFetch(`/movie/${movieID}?language=ko-KR`);
    const {data:people, isLoadingP, isErrorP} = useDetailFetch (`/movie/${movieID}/credits?language=ko-KR`);
