...
import MovieDetailInfo from "../components/MovieDetailInfo.jsx";
import MovieDetailPeople from "../components/MovieDetailPeople.jsx";
import { useQuery } from "@tanstack/react-query";
import {
  useGetMovieVideos,
  useGetMoviesCredit,
  useGetMoviesDetail,
} from "../hooks/queries/useGetMovies.ts";
import styled from "styled-components";
import { MovieCast } from "../types/movie.ts";
...
function MovieDetailPage() {
  ...
  if (!movieId) {
    throw new Error("movieId is required to fetch movie credits.");
  }
